...
HostSettingCharCodeForm::Code HostSettingCharCodeForm::Private::getHostCode() const {
    Code ret = Code::NOP;
...
HostSettingCharCodeForm::Code HostSettingCharCodeForm::Private::getFileCode() const {
    Code ret = Code::AUTO;
